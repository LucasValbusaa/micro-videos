...
} from "@micro-videos/core/src/cast-member/domain";
...
describe("CastMembersController Integration Tests", () => {
  ...
  it("should delete a category", async () => {
    ...
    await expect(repository.findById(castMember.id.value)).rejects.toThrow(
      new NotFoundError(`Entity Not Found using ID ${castMember.id.value}`),
    );
  });
